...
export default function Navbar({ initialProfile }) {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gray-800/80 backdrop-blur after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
