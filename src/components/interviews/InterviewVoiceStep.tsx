...
function VoiceInterviewContent({ role }: { role: string }) {
  const {
                  ...
                  <div className="mt-4">
                    {interviewRecapUrl ? (
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-slate-500">
                          Der Recap mischt die Interviewer- und
                          Kandidatenstimme in eine gemeinsame Datei.
                        </p>
                      </div>
                    ) : interviewRecapStatus === "recording" ? (
                      <p className="text-sm text-slate-600">
                        Das komplette Interview wird parallel mitgeschnitten und
                        steht nach dem Beenden hier bereit.
                      </p>
                      ...
                      <p className="text-sm text-slate-600">
                        Nach dem Call kannst du hier das gesamte Interview
                        abspielen.
                      </p>
                    )}
                ...
                <div className="rounded-[20px] border bg-slate-50 p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Nur Metriken, die im Transkript nicht direkt sichtbar
                        sind
                      </p>
                    </div>
                    <span className="rounded-full border bg-white px-3 py-1.5 text-xs text-slate-600">
                  ...
                  <div className="mt-4">
                    {hasTimingMetrics ? (
                          ...
                          <dd className="mt-1 text-lg font-semibold text-slate-900">
                            {formatCountdown(
                              Math.max(
                                0,
                                Math.round(
                                  interviewTimingMetrics.totalCandidateSpeechMs /
                                    1_000
                                )
                              )
                            )}
                      ...
                      <p className="text-sm text-slate-600">
                        Sobald der Kandidat auf eine Frage antwortet, erscheinen
                        hier Antwortdauer, Reaktionszeit und Sprechtempo.
                      </p>
                    ) : (
                      <p className="text-sm text-slate-600">
                        Nach dem ersten beantworteten Interviewturn erscheinen
                        hier reine Timing-Metriken.
                      </p>
                    )}
                  </div>
                </div>
