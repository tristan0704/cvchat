...
export const metadata = {
  title: "Datenschutz | CommIT",
  description: "Datenschutzhinweise für CommIT.",
};
...
const DATA_POLICY_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "CommIT verarbeitet je nach Nutzung insbesondere Registrierungsdaten, Profildaten, hochgeladene CV-Dateien, Interviewkonfigurationen, Antworten innerhalb von Interviewsimulationen sowie daraus abgeleitete Feedback- und Bewertungsdaten.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Für eine bessere Leistung verwenden wir externe KI- oder Infrastrukturprovider wie OpenAI und Google. ",
    ],
  },
  {
