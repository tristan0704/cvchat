...
function CodingPageContent() {
    ...
    const nextHref = `/simulate/coding-feedback?${new URLSearchParams({ token, role }).toString()}`
            ...
            <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
                <header className="mb-6 flex items-center justify-between rounded-[28px] border bg-white p-4">
                    ...
                    <div className="flex gap-2">
                        <Link
                            href={`/simulate/interview-feedback?${new URLSearchParams({ token, role }).toString()}`}
                ...
                <section className="rounded-[28px] border bg-white p-8">
                    ...
                    <h2 className="mt-3 text-3xl font-semibold tracking-tight">Vorbereitete Coding Challenge</h2>
                    <p className="mt-4 max-w-2xl text-sm text-slate-700">
                        Hier kommt spaeter der technische Teil fuer {role} hinein. Aktuell ist diese Seite nur ein
                        einfacher Platzhalter fuer Aufgabenstellung, Antwort und Auswertung.
                    </p>
